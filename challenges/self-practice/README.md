...
| [**botsv2/**](botsv2/) | BOTS v2 (`./setup.sh --v2`) | 60 exercises Q1–Q60: fundamentals → intermediate SPL → log analysis (query fluency first), with [SOLUTIONS](botsv2/SOLUTIONS.md) |
